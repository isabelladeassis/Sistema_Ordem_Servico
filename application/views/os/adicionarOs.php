                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span3">
                                            ...
                                            <select class="span12" name="prioridade" id="prioridade" value="">
                                                <option value="Urgente">Orçamento</option>
                                                <option value="Alta">Aberto</option>
                                                <option value="Normal">Em Andamento</option>
                                                <option value="Baixa">Finalizado</option>
                                                <option value="Mínima">Cancelado</option>
                                            </select>
                                        </div>
                                        <div class="span3">
